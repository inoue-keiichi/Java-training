...
public class ConstructorPrintGenerator extends PrintGenerator {
	private static final ConstructorPrintGenerator constructorPrintGenerator = new ConstructorPrintGenerator();

	private final ConstructorPanel constructorPanel = ConstructorPanel.getInstance();
	...
	public void execute() {
		...
		final JComboBox<String> constructorComboBox = constructorPanel.getConstructorComboBox();
		// 元々あった選択肢を削除
