...
public class Game {
	...
	public static Map<GameResult, Integer> result;
	private static final Map<String, List<Map<GameResult, Integer>>> scoreRecode = new HashMap<>();
	private static Queue<String> players = new LinkedList<String>() {
		{
			add("/Users/user/git/Java-training/jpl/bin/ch16/ex12/ResourcePlayer");
			add("/Users/user/git/Java-training/jpl/bin/ch16/ex12/ResourcePlayer");
			add("/Users/user/git/Java-training/jpl/bin/ch16/ex12/ResourcePlayer");
			add("/Users/user/git/Java-training/jpl/bin/ch16/ex12/ResourcePlayer");
			add("/Users/user/git/Java-training/jpl/bin/ch16/ex12/ResourcePlayer");
