...
public class MenuFactory {
	...
	public static <T> MenuView create(final DIGenerator generator, final DIService service, final String name, final String[] menuItemNames) {
		...
		if (menuItemNames.length <= MENU_ITEM_DISPLAY_NUMBER) {
			for (final String itemName : menuItemNames) {
	...
	public static <T> MenuView create(final DIGenerator generator, final DIService service, final String name, final Map<String, T> map) {
		final MenuView menuView = new MenuView(generator, service);
		menuView.view.setText(name);
		final MenuTemplate menuTemplate = new MenuTemplate(menuView);
	...
	private static <T> void addItemWithIcon(final MenuView menuView, final Entry<String, T> entry, final MenuTemplate menuTemplate) {
