...
import dc3_4.frame.clock.ClockController;
import dc3_4.frame.clock.ClockService;
import dc3_4.frame.clock.ClockType;
import dc3_4.frame.clock.TetrisClockController;
import dc3_4.frame.game.tetris.TetrisController;
import dc3_4.frame.menu.MenuDialogController;
import dc3_4.frame.menu.MenuDialogObservable;
...
public class FrameController implements PropertyChangeListener, Initializable {
	...
	//		final URL location = getClass().getResource("FrameView.fxml");
	...
	//		this.mode = frameService.getScreenMode();
	//
	...
	//			frameService.saveScreenMode(mode);
	//			System.exit(0);
	//		});
	//
	//	}
	...
	public void initView(final Stage stage) {
		...
		stage.setY(frameService.getY());
		//		stage.setHeight(frameService.getHeight());
		//		stage.setWidth(frameService.getWidth());
		stage.show();
