...
public class PopupMenuUtility {
	public static final String[] FONT_SIZES = { "100", "120", "130", "140", "150", "160", "170", "180", "190", "200",
			"250", "300" };
	public static final String[] FONT_COLORS = { "green", "black", "blue", "cyan", "darkGray", "gray", "lightGray",
			"magenta", "orange", "pink", "red", "white", "yellow" };
	public static final String[] BACKGROUND_COLORS = { "black", "blue", "cyan", "darkGray", "gray", "green",
